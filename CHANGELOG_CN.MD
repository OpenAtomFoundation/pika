...
- `PkPatternMatchDel` 命令在删除 DB 的同时删除 RedisCache，避免出现RocksDb 数据库与 RedisCache 缓存数据不一致的情况[#2839](https://github.com/OpenAtomFoundation/pika/pull/2839)@[chejinge](https://github.com/chejinge)
