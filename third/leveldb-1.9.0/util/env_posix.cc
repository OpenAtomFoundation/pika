...
namespace leveldb {
    ...
    namespace {
        ...
        class PosixEnv : public Env {
            public:
                ...
                virtual Status UnlockFile(FileLock* lock) {
                    ...
                    Status result;
                    printf("call env_posix.cc unlock function\n");
        ...
        void PosixEnv::Schedule(void (*function)(void*), void* arg) {
            ...
            // 在BGThread 函数就是一个死循环, 不断的从这个queue_ 里面读出, 这个是FIFO的形式
            // 读出, 先进先出. 没有做一个优先级的概念.
            ...
            // waiting.
            // 如果这个queue_ 里面的数据当前是空的, 则等待cond 锁让它起来
            if (queue_.empty()) {
        ...
        // Compaction 主要执行的地方, 一直死循环 不断检查queue_里面是否有数据
        void PosixEnv::BGThread() {
            while (true) {
                ...
                PthreadCall("unlock", pthread_mutex_unlock(&mu_));
                (*function)(arg);  // 调用这个函数, 应该是 DBImpl::BGWork 函数
            }
        }
