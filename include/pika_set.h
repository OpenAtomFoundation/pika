...
class SAddCmd : public Cmd {
 public:
  ...
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SAddCmd(*this); }
...
class SPopCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SPopCmd(*this); }
...
class SCardCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SCardCmd(*this); }
...
class SMembersCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SMembersCmd(*this); }
...
class SScanCmd : public Cmd {
 public:
  SScanCmd(const std::string& name, int arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*"), count_(10) {}
  virtual std::vector<std::string> current_key() const {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SRemCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SRemCmd(*this); }
...
class SUnionstoreCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SUnionstoreCmd(*this); }
...
class SInterCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SInterCmd(*this); }
...
class SInterstoreCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SInterstoreCmd(*this); }
...
class SIsmemberCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SIsmemberCmd(*this); }
...
class SDiffCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SDiffCmd(*this); }
...
class SDiffstoreCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SDiffstoreCmd(*this); }
...
class SMoveCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SMoveCmd(*this); }
...
class SRandmemberCmd : public Cmd {
 public:
  SRandmemberCmd(const std::string& name, int arity, uint16_t flag) : Cmd(name, arity, flag), count_(1) {}
  virtual std::vector<std::string> current_key() const {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SRandmemberCmd(*this); }
