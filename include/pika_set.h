...
class SAddCmd : public Cmd {
 public:
  SAddCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
...
class SPopCmd : public Cmd {
 public:
  SPopCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SCardCmd : public Cmd {
 public:
  SCardCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SMembersCmd : public Cmd {
 public:
  SMembersCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SScanCmd : public Cmd {
 public:
  SScanCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*") {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SRemCmd : public Cmd {
 public:
  SRemCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SUnionCmd : public Cmd {
 public:
  SUnionCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SetOperationCmd : public Cmd{
 public:
  SetOperationCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {
...
class SUnionstoreCmd : public SetOperationCmd {
 public:
  SUnionstoreCmd(const std::string& name, int32_t arity, uint16_t flag) : SetOperationCmd(name, arity, flag) {}
...
class SInterCmd : public Cmd {
 public:
  SInterCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SInterstoreCmd : public SetOperationCmd {
 public:
  SInterstoreCmd(const std::string& name, int32_t arity, uint16_t flag) : SetOperationCmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SIsmemberCmd : public Cmd {
 public:
  SIsmemberCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SDiffCmd : public Cmd {
 public:
  SDiffCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SDiffstoreCmd : public SetOperationCmd {
 public:
  SDiffstoreCmd(const std::string& name, int32_t arity, uint16_t flag) : SetOperationCmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SMoveCmd : public Cmd {
 public:
  SMoveCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {
...
class SRandmemberCmd : public Cmd {
 public:
  SRandmemberCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
