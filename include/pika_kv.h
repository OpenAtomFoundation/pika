...
class SetCmd : public Cmd {
 public:
  ...
  SetCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {};
...
class GetCmd : public Cmd {
 public:
  GetCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class DelCmd : public Cmd {
 public:
  DelCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
...
class IncrCmd : public Cmd {
 public:
  IncrCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class IncrbyCmd : public Cmd {
 public:
  IncrbyCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class IncrbyfloatCmd : public Cmd {
 public:
  IncrbyfloatCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class DecrCmd : public Cmd {
 public:
  DecrCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class DecrbyCmd : public Cmd {
 public:
  DecrbyCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class GetsetCmd : public Cmd {
 public:
  GetsetCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class AppendCmd : public Cmd {
 public:
  AppendCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class MgetCmd : public Cmd {
 public:
  MgetCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag){};
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  std::vector<std::string> current_key() const override { return keys_; }
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override;
  void Merge() override;
...
class KeysCmd : public Cmd {
 public:
  KeysCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class SetnxCmd : public Cmd {
 public:
  SetnxCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SetexCmd : public Cmd {
 public:
  SetexCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PsetexCmd : public Cmd {
 public:
  PsetexCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class DelvxCmd : public Cmd {
 public:
  DelvxCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class MsetCmd : public Cmd {
 public:
  MsetCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {
...
class MsetnxCmd : public Cmd {
 public:
  MsetnxCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {
    set_cmd_ = std::make_shared<SetCmd>(kCmdNameSet, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv);
  }
...
class GetrangeCmd : public Cmd {
 public:
  GetrangeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class SetrangeCmd : public Cmd {
 public:
  SetrangeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class StrlenCmd : public Cmd {
 public:
  StrlenCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class ExistsCmd : public Cmd {
 public:
  ExistsCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  std::vector<std::string> current_key() const override { return keys_; }
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override;
  void Merge() override;
...
class ExpireCmd : public Cmd {
 public:
  ExpireCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PexpireCmd : public Cmd {
 public:
  PexpireCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class ExpireatCmd : public Cmd {
 public:
  ExpireatCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PexpireatCmd : public Cmd {
 public:
  PexpireatCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class TtlCmd : public Cmd {
 public:
  TtlCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PttlCmd : public Cmd {
 public:
  PttlCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PersistCmd : public Cmd {
 public:
  PersistCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class TypeCmd : public Cmd {
 public:
  TypeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PTypeCmd : public Cmd {
 public:
  PTypeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class ScanCmd : public Cmd {
 public:
  ScanCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*") {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class ScanxCmd : public Cmd {
 public:
  ScanxCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*") {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override{};
  void Merge() override{};
...
class PKSetexAtCmd : public Cmd {
 public:
  PKSetexAtCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_);
    return res;
...
class PKScanRangeCmd : public Cmd {
 public:
  PKScanRangeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*") {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
...
class PKRScanRangeCmd : public Cmd {
 public:
  PKRScanRangeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag), pattern_("*") {}
  std::vector<std::string> current_key() const override {
    std::vector<std::string> res;
    res.push_back(key_start_);
    return res;
