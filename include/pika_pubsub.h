...
class PublishCmd : public Cmd {
 public:
  ...
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new PublishCmd(*this); }
...
class SubscribeCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new SubscribeCmd(*this); }
...
class UnSubscribeCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new UnSubscribeCmd(*this); }
...
class PUnSubscribeCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new PUnSubscribeCmd(*this); }
...
class PSubscribeCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new PSubscribeCmd(*this); }
...
class PubSubCmd : public Cmd {
 public:
  ...
  virtual void Split(std::shared_ptr<Partition> partition, const HintKeys& hint_keys){};
  virtual void Merge(){};
  virtual Cmd* Clone() override { return new PubSubCmd(*this); }
