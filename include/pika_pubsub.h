...
class PublishCmd : public Cmd {
 public:
  PublishCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
...
class SubscribeCmd : public Cmd {
 public:
  SubscribeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override {};
  void Merge() override {};
...
class UnSubscribeCmd : public Cmd {
 public:
  UnSubscribeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override {};
  void Merge() override {};
...
class PUnSubscribeCmd : public Cmd {
 public:
  PUnSubscribeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override {};
  void Merge() override {};
...
class PSubscribeCmd : public Cmd {
 public:
  PSubscribeCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override {};
  void Merge() override {};
...
class PubSubCmd : public Cmd {
 public:
  PubSubCmd(const std::string& name, int32_t arity, uint16_t flag) : Cmd(name, arity, flag) {}
  void Do(std::shared_ptr<Slot> slot = nullptr) override;
  void Split(std::shared_ptr<Slot> slot, const HintKeys& hint_keys) override {};
  void Merge() override {};
