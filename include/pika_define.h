...
//migrate
#define PIKA_REPL_SLOT_CONNECT 6
#define PIKA_REPL_SLOT_CONNECTING 7
#define PIKA_REPL_SLOT_CONNECTED 8
#define PIKA_REPL_SLOT_WAIT_DBSYNC 9
#define PIKA_REPL_SLOT_ERROR 10
