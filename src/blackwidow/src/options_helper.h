...
static std::unordered_map<std::string, MemberTypeInfo> mutable_db_options_member_type_info = {
    ...
    {"max_total_wal_size", {offsetof(struct rocksdb::DBOptions, max_total_wal_size), MemberType::kUint64T}},
    {"wal_bytes_per_sync", {offsetof(struct rocksdb::DBOptions, wal_bytes_per_sync), MemberType::kUint64T}},
    {"stats_dump_period_sec", {offsetof(struct rocksdb::DBOptions, stats_dump_period_sec), MemberType::kUint}},
};
