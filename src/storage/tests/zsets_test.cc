...
TEST_F(ZSetsTest, ZPopMaxTest){  
  ...
  ASSERT_TRUE(score_members_match(&db, "GP1_ZPOPMAX_KEY", {{-0.54, "MM4"}, {0, "MM2"}, {3.23, "MM1"}, {8.0004, "MM3"}}));
  ...
  ASSERT_TRUE(score_members_match(score_members, {{2e5 + 3.98, "MM9"}, {2e5 + 3.98, "MM10"}, {1, "MM2"}, {1, "MM1"}, {0.532445, "MM8"}}));
  ASSERT_TRUE(score_members_match(&db, "GP3_ZPOPMAX_KEY", {{-1, "MM3"}, {-1, "MM4"}, {1/6.0, "MM5"}, {1/6.0, "MM6"}, {0.532445, "MM7"}}));  
...
TEST_F(ZSetsTest, ZPopMinTest) { 
  ...
  ASSERT_TRUE(score_members_match(&db, "GP1_ZPOPMIN_KEY", {{-0.54, "MM4"}, {0, "MM2"}, {3.23, "MM1"}, {8.0004, "MM3"}}));
  std::vector<storage::ScoreMember> score_members;
  ...
  ASSERT_TRUE(score_members_match(&db, "GP3_ZPOPMIN_KEY", {{0.532445, "MM8"}, {1, "MM1"}, {1, "MM2"}, {2e5 + 3.98, "MM10"}, {2e5 + 3.98, "MM9"}}));
  ASSERT_TRUE(score_members_match(score_members,{{-1, "MM3"}, {-1, "MM4"}, {1/6.0, "MM5"}, {1/6.0, "MM6"}, {0.532445, "MM7"}}));  
...
TEST_F(ZSetsTest, ZRangebyscoreTest) {
  ...
  // ***************** Group 1 Test *****************
  std::vector<storage::ScoreMember> gp1_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
  ...
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                  {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                  { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // count = max offset = 0
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, std::numeric_limits<int64_t>::max(), 0, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
  ...
  // count = 18 offset = 0
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 18, 0, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
  ...
  // count = 10 offset = 0
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 0, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
  ...
  // count = 10 offset = 1
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 1, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {                              {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                  {-100.0000000000001, "MM10"}, { 0,                 "MM11"}}));

  // count = 10 offset = 17
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 17, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}}));

  // count = 10 offset = 18
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 18, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {}));

  // count = 10 offset = 19
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 19, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {}));

  // count = 10000 offset = 1
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10000, 1, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {                              {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
  ...
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10000, 10000, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {}));

  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), -1000.000000000001, true, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                  {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" }}));

  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), -1000.000000000001, true, false, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                  {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" }}));

  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", -1000.000000000001, std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                  {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                  { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                  { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));

  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", -1000.000000000001, std::numeric_limits<double>::max(), false, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                  { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                  { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" }}));
  ...
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{ 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                  { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));

  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", 4321.000000000001, 987654321.0000001, false, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {                              { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                  { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  s = db.ZRangebyscore("GP1_ZRANGEBYSCORE_KEY", 999999999, std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {}));
  ...
  s = db.ZRangebyscore("GP2_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.IsNotFound());
  ASSERT_TRUE(score_members_match(score_members, {}));


  // ***************** Group 3 Test *****************
  s = db.ZRangebyscore("GP3_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.IsNotFound());
  ASSERT_TRUE(score_members_match(score_members, {}));


  // ***************** Group 4 Test *****************
  std::vector<storage::ScoreMember> gp4_sm {{std::numeric_limits<double>::lowest(), "MM0"},
                                               {0, "MM1"},
  ...
  s = db.ZRangebyscore("GP4_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{std::numeric_limits<double>::lowest(), "MM0"}, {0, "MM1"}, {std::numeric_limits<double>::max(), "MM2"}}));

  s = db.ZRangebyscore("GP4_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), false, false, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{0, "MM1"}}));

  s = db.ZRangebyscore("GP4_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, false, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{std::numeric_limits<double>::lowest(), "MM0"}, {0, "MM1"}}));

  s = db.ZRangebyscore("GP4_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), false, true, &score_members);
  ASSERT_TRUE(s.ok());
...
//   //     0         1         2        3        4        5        6
//   std::vector<storage::ScoreMember> gp1_sm {{-5, "MM0"}, {-3, "MM1"}, {-1, "MM2"}, {0, "MM3"}, {1, "MM4"}, {3, "MM5"}, {5, "MM6"}};
...
//   // ***************** Group 2 Test *****************
//   std::vector<storage::ScoreMember> gp2_sm {{-5, "MM0"}, {-3, "MM1"}, {-1, "MM2"}, {0, "MM3"}, {1, "MM4"}, {3, "MM5"}, {5, "MM6"}};
...
TEST_F(ZSetsTest, ZRemTest) {
  ...
  // {-5, MM0} {-3, MM1} {-1, MM2} {0, MM3} {1, MM4} {3, MM5} {5, MM6}
  //     0         1         2        3        4        5        6
  std::vector<storage::ScoreMember> gp3_sm {{-5, "MM0"}, {-3, "MM1"}, {-1, "MM2"}, {0, "MM3"}, {1, "MM4"}, {3, "MM5"}, {5, "MM6"}};
  ...
  // {-5, MM0} {-3, MM1} {-1, MM2} {0, MM3} {1, MM4} {3, MM5} {5, MM6}
  //     0         1         2        3        4        5        6
  std::vector<storage::ScoreMember> gp4_sm {{-5, "MM0"}, {-3, "MM1"}, {-1, "MM2"}, {0, "MM3"}, {1, "MM4"}, {3, "MM5"}, {5, "MM6"}};
  ...
  // {-5, MM0} {-3, MM1} {-1, MM2} {0, MM3} {1, MM4} {3, MM5} {5, MM6}
  //     0         1         2        3        4        5        6
  std::vector<storage::ScoreMember> gp5_sm {{-5, "MM0"}, {-3, "MM1"}, {-1, "MM2"}, {0, "MM3"}, {1, "MM4"}, {3, "MM5"}, {5, "MM6"}};
...
TEST_F(ZSetsTest, ZRemrangebyscoreTest) {
  ...
  // ***************** Group 2 Test *****************
  std::vector<storage::ScoreMember> gp2_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP2_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // ***************** Group 3 Test *****************
  std::vector<storage::ScoreMember> gp3_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP3_ZREMRANGEBYSCORE_KEY",{{-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  // ***************** Group 4 Test *****************
  std::vector<storage::ScoreMember> gp4_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP4_ZREMRANGEBYSCORE_KEY",{{-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  // ***************** Group 5 Test *****************
  std::vector<storage::ScoreMember> gp5_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP5_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  // ***************** Group 6 Test *****************
  std::vector<storage::ScoreMember> gp6_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP6_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  // ***************** Group 7 Test *****************
  std::vector<storage::ScoreMember> gp7_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP7_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"},                               { 100.0000000000001, "MM12"},
                                                                   { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));


  // ***************** Group 8 Test *****************
  std::vector<storage::ScoreMember> gp8_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP8_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                   { 7654321.000000001, "MM16"}, { 87654321.00000001, "MM17"}, { 987654321.0000001, "MM18"}}));
  ...
  // ***************** Group 9 Test *****************
  std::vector<storage::ScoreMember> gp9_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                               {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                               {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                               {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                               { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP9_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                   {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                   {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                   {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"}}));
  ...
  // ***************** Group 10 Test *****************
  std::vector<storage::ScoreMember> gp10_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  ASSERT_TRUE(score_members_match(&db, "GP10_ZREMRANGEBYSCORE_KEY",{{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                                    {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                                    {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                                    {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                                    { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // ***************** Group 11 Test *****************
  std::vector<storage::ScoreMember> gp11_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // ***************** Group 14 Test *****************
  std::vector<storage::ScoreMember> gp14_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // ***************** Group 15 Test *****************
  std::vector<storage::ScoreMember> gp15_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
  ...
  // ***************** Group 16 Test *****************
  std::vector<storage::ScoreMember> gp16_sm {{-987654321.0000001, "MM1" }, {-87654321.00000001, "MM2" }, {-7654321.000000001, "MM3" },
                                                {-654321.0000000001, "MM4" }, {-54321.00000000001, "MM5" }, {-4321.000000000001, "MM6" },
                                                {-1000.000000000001, "MM7" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM9" },
                                                {-100.0000000000001, "MM10"}, { 0,                 "MM11"}, { 100.0000000000001, "MM12"},
                                                { 4321.000000000001, "MM13"}, { 54321.00000000001, "MM14"}, { 654321.0000000001, "MM15"},
...
TEST_F(ZSetsTest, ZRevrangeTest) {
  ...
  ASSERT_TRUE(score_members_match(&db, "GP2_ZREVRANGE_KEY", {{0, "MM0"}, {1, "MM1"}, {2, "MM2"},
                                                             {3, "MM3"}, {4, "MM4"}, {5, "MM5"},
                                                             {6, "MM6"}, {7, "MM7"}, {8, "MM8"}}));

  s = db.ZRevrange("GP2_ZREVRANGE_KEY", 0, 8, &score_members);
  ASSERT_TRUE(s.ok());
  ASSERT_TRUE(score_members_match(score_members, {{8, "MM8"}, {7, "MM7"}, {6, "MM6"},
                                                  {5, "MM5"}, {4, "MM4"}, {3, "MM3"},
                                                  {2, "MM2"}, {1, "MM1"}, {0, "MM0"}}));
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//                                                   {-7654321.000000001, "MM3" }, {-87654321.00000001, "MM2" }, {-987654321.0000001, "MM1" }}));

//   // count = max offset = 0
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, std::numeric_limits<int64_t>::max(), 0, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   // count = 18 offset = 0
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 18, 0, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   // count = 10 offset = 0
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 0, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   // count = 10 offset = 1
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 1, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {                              { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
//                                                   {-1000.000000000001, "MM9" }, {-1000.000000000001, "MM8" }}));

//   // count = 10 offset = 2
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 2, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {                                                            { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
//                                                   {-1000.000000000001, "MM9" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM7" }}));

//   // count = 10 offset = 17
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 17, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{-987654321.0000001, "MM1" }}));

//   // count = 10 offset = 18
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 18, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {}));

//   // count = 10 offset = 19
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10, 19, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {}));

//   // count = 10000 offset = 1
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10000, 1, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {                              { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   // count = 10000 offset = 10000
//   s = db.ZRevrangebyscore("GP1_ZRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, 10000, 10000, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), -1000.000000000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{-1000.000000000001, "MM9" }, {-1000.000000000001, "MM8" }, {-1000.000000000001, "MM7" },
//                                                   {-4321.000000000001, "MM6" }, {-54321.00000000001, "MM5" }, {-654321.0000000001, "MM4" },
//                                                   {-7654321.000000001, "MM3" }, {-87654321.00000001, "MM2" }, {-987654321.0000001, "MM1" }}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), -1000.000000000001, true, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{-4321.000000000001, "MM6" }, {-54321.00000000001, "MM5" }, {-654321.0000000001, "MM4" },
//                                                   {-7654321.000000001, "MM3" }, {-87654321.00000001, "MM2" }, {-987654321.0000001, "MM1" }}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -1000.000000000001, std::numeric_limits<double>::max(), true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -1000.000000000001, std::numeric_limits<double>::max(), false, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"}}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -987654321.0000001, 987654321.0000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -987654321.0000001, 987654321.0000001, false, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {                              { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -654321.0000000001, -4321.000000000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{-4321.000000000001, "MM6" }, {-54321.00000000001, "MM5" }, {-654321.0000000001, "MM4" }}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -654321.0000000001, -4321.000000000001, false, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{-54321.00000000001, "MM5" }}));
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", 4321.000000000001, 987654321.0000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"}}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", 4321.000000000001, 987654321.0000001, false, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"},                            }));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", 4321.000000000001, 987654321.0000001, false, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {                              { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"},                            }));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -1000.000000000001, 987654321.0000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"},
...
//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", -1000.000000000001, 987654321.0000001, false, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{ 987654321.0000001, "MM18"}, { 87654321.00000001, "MM17"}, { 7654321.000000001, "MM16"},
//                                                   { 654321.0000000001, "MM15"}, { 54321.00000000001, "MM14"}, { 4321.000000000001, "MM13"},
//                                                   { 100.0000000000001, "MM12"}, { 0,                 "MM11"}, {-100.0000000000001, "MM10"}}));

//   s = db.ZRevrangebyscore("GP1_ZREVRANGEBYSCORE_KEY", 999999999, std::numeric_limits<double>::max(), true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {}));
...
//   s = db.ZRevrangebyscore("GP2_ZREVRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
//   ASSERT_TRUE(s.IsNotFound());
//   ASSERT_TRUE(score_members_match(score_members, {}));


//   // ***************** Group 3 Test *****************
//   s = db.ZRevrangebyscore("GP3_ZREVRANGEBYSCORE_KEY", std::numeric_limits<double>::lowest(), std::numeric_limits<double>::max(), true, true, &score_members);
//   ASSERT_TRUE(s.IsNotFound());
//   ASSERT_TRUE(score_members_match(score_members, {}));
...
//   s = db.ZRevrangebyscore("GP4_ZREVRANGEBYSCORE_KEY", -1000000000.0000000001, 1000000000.0000000001, true, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{1000000000.0000000001, "MM2"}, {0, "MM1"}, {-1000000000.0000000001, "MM0"}}));

//   s = db.ZRevrangebyscore("GP4_ZREVRANGEBYSCORE_KEY", -1000000000.0000000001, 1000000000.0000000001, false, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{0, "MM1"}}));

//   s = db.ZRevrangebyscore("GP4_ZREVRANGEBYSCORE_KEY", -1000000000.0000000001, 1000000000.0000000001, true, false, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{0, "MM1"}, {-1000000000.0000000001, "MM0"}}));

//   s = db.ZRevrangebyscore("GP4_ZREVRANGEBYSCORE_KEY", -1000000000.0000000001, 1000000000.0000000001, false, true, &score_members);
//   ASSERT_TRUE(s.ok());
//   ASSERT_TRUE(score_members_match(score_members, {{1000000000.0000000001, "MM2"}, {0, "MM1"}}));
// }
...
TEST_F(ZSetsTest, ZScoreTest) {
  ...
  // ***************** Group 1 Test *****************
  std::vector<storage::ScoreMember> gp1_sm {{54354.497895352, "MM1"}, {100.987654321,  "MM2"},
                                               {-100.000000001,  "MM3"}, {-100.000000002, "MM4"},
                                               {-100.000000001,  "MM5"}, {-100.000000002, "MM6"}};
...
TEST_F(ZSetsTest, ZUnionstoreTest) {
  ...
  s = db.ZUnionstore("GP1_ZUNIONSTORE_DESTINATION", {"GP1_ZUNIONSTORE_SM1", "GP1_ZUNIONSTORE_SM2", "GP1_ZUNIONSTORE_SM3"}, {1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP2_ZUNIONSTORE_DESTINATION", {"GP2_ZUNIONSTORE_SM1", "GP2_ZUNIONSTORE_SM2", "GP2_ZUNIONSTORE_SM3"}, {1, 1, 1}, storage::MIN, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP3_ZUNIONSTORE_DESTINATION", {"GP3_ZUNIONSTORE_SM1", "GP3_ZUNIONSTORE_SM2", "GP3_ZUNIONSTORE_SM3"}, {1, 1, 1}, storage::MAX, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP4_ZUNIONSTORE_DESTINATION", {"GP4_ZUNIONSTORE_SM1", "GP4_ZUNIONSTORE_SM2", "GP4_ZUNIONSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP5_ZUNIONSTORE_DESTINATION", {"GP5_ZUNIONSTORE_SM1", "GP5_ZUNIONSTORE_SM2", "GP5_ZUNIONSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP6_ZUNIONSTORE_DESTINATION", {"GP6_ZUNIONSTORE_SM1", "GP6_ZUNIONSTORE_SM2", "GP6_ZUNIONSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP7_ZUNIONSTORE_DESTINATION", {"GP7_ZUNIONSTORE_SM1", "GP7_ZUNIONSTORE_SM2", "GP7_ZUNIONSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  s = db.ZUnionstore("GP8_ZUNIONSTORE_DESTINATION", {"GP8_ZUNIONSTORE_SM1", "GP8_ZUNIONSTORE_SM2", "GP8_ZUNIONSTORE_SM3"}, {1, 1, 1}, storage::MIN, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP9_ZUNIONSTORE_DESTINATION", {"GP9_ZUNIONSTORE_SM1", "GP9_ZUNIONSTORE_SM2", "GP9_ZUNIONSTORE_SM3"}, {1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZUnionstore("GP10_ZUNIONSTORE_DESTINATION",
      {"GP10_ZUNIONSTORE_SM1", "GP10_ZUNIONSTORE_SM2", "GP10_ZUNIONSTORE_SM3","GP10_ZUNIONSTORE_SM4"}, {1, 1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(ZSetsTest, ZInterstoreTest) {
  ...
  s = db.ZInterstore("GP1_ZINTERSTORE_DESTINATION", {"GP1_ZINTERSTORE_SM1", "GP1_ZINTERSTORE_SM2", "GP1_ZINTERSTORE_SM3"}, {1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZInterstore("GP2_ZINTERSTORE_DESTINATION", {"GP2_ZINTERSTORE_SM1", "GP2_ZINTERSTORE_SM2", "GP2_ZINTERSTORE_SM3"}, {1, 1, 1}, storage::MIN, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZInterstore("GP3_ZINTERSTORE_DESTINATION", {"GP3_ZINTERSTORE_SM1", "GP3_ZINTERSTORE_SM2", "GP3_ZINTERSTORE_SM3"}, {1, 1, 1}, storage::MAX, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZInterstore("GP4_ZINTERSTORE_DESTINATION", {"GP4_ZINTERSTORE_SM1", "GP4_ZINTERSTORE_SM2", "GP4_ZINTERSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZInterstore("GP5_ZINTERSTORE_DESTINATION", {"GP5_ZINTERSTORE_SM1", "GP5_ZINTERSTORE_SM2", "GP5_ZINTERSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.ZInterstore("GP6_ZINTERSTORE_DESTINATION", {"GP6_ZINTERSTORE_SM1", "GP6_ZINTERSTORE_SM2", "GP6_ZINTERSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
  ...
  s = db.ZInterstore("GP7_ZINTERSTORE_DESTINATION", {"GP7_ZINTERSTORE_SM1", "GP7_ZINTERSTORE_SM2", "GP7_ZINTERSTORE_SM3"}, {1, 2, 3}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
  ...
  s = db.ZInterstore("GP8_ZINTERSTORE_DESTINATION", {"GP8_ZINTERSTORE_SM1", "GP8_ZINTERSTORE_SM2", "GP8_ZINTERSTORE_SM3"}, {1, 1, 1}, storage::MIN, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
  ...
  s = db.ZInterstore("GP9_ZINTERSTORE_DESTINATION", {"GP9_ZINTERSTORE_SM1", "GP9_ZINTERSTORE_SM2", "GP9_ZINTERSTORE_SM3"}, {1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.ZInterstore("GP10_ZINTERSTORE_DESTINATION",
      {"GP10_ZINTERSTORE_SM1", "GP10_ZINTERSTORE_SM2", "GP10_ZINTERSTORE_SM3", "GP10_ZINTERSTORE_SM4"}, {1, 1, 1, 1}, storage::SUM, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
