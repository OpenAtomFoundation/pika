...
TEST_F(ZSetsTest, ZRemrangebyscoreTest) {  // NOLINT
  ...
  // ***************** Group 17 Test *****************
  std::vector<storage::ScoreMember> gp17_sm{{-987654321.0000001, "MM1"},
                                            {-87654321.00000001, "MM2"},
                                            {-7654321.000000001, "MM3"},
                                            {-654321.0000000001, "MM4"},
                                            {-54321.00000000001, "MM5"},
  ...
  s = db.ZAdd("GP17_ZREMRANGEBYSCORE_KEY", gp17_sm, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(18, ret);
  s = db.ZRemrangebyscore("GP17_ZREMRANGEBYSCORE_KEY", -987654321.0000001, -7654321.000000001, false, false, &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(1, ret);
  ASSERT_TRUE(size_match(&db, "GP17_ZREMRANGEBYSCORE_KEY", 17));
  ASSERT_TRUE(score_members_match(&db, "GP17_ZREMRANGEBYSCORE_KEY",
                                  {{-987654321.0000001, "MM1"},
                                   {-7654321.000000001, "MM3"},
                                   {-654321.0000000001, "MM4"},
                                   {-54321.00000000001, "MM5"},
    ...
    // ***************** Group 18 Test *****************
    std::vector<storage::ScoreMember> gp18_sm{{-987654321.0000001, "MM1"},
                                              {-87654321.00000001, "MM2"},
                                              {-7654321.000000001, "MM3"},
                                              {-654321.0000000001, "MM4"},
                                              {-54321.00000000001, "MM5"},
                                              {-54321.00000000001, "MM6"},
                                              {-54321.00000000001, "MM7"},
                                              {-1000.000000000001, "MM8"},
                                              {-1000.000000000001, "MM9"},
                                              {-100.0000000000001, "MM10"},
                                              {0, "MM11"},
    ...
    s = db.ZAdd("GP18_ZREMRANGEBYSCORE_KEY", gp18_sm, &ret);
    ASSERT_TRUE(s.ok());
    ASSERT_EQ(18, ret);
    s = db.ZRemrangebyscore("GP18_ZREMRANGEBYSCORE_KEY", -987654321.0000001, -54321.00000000001, false, false, &ret);
    ASSERT_TRUE(s.ok());
    ASSERT_EQ(3, ret);
    ASSERT_TRUE(size_match(&db, "GP18_ZREMRANGEBYSCORE_KEY", 15));
    ASSERT_TRUE(score_members_match(&db, "GP18_ZREMRANGEBYSCORE_KEY",
                                    {{-987654321.0000001, "MM1"},
                                     {-54321.00000000001, "MM5"},
                                     {-54321.00000000001, "MM6"},
                                     {-54321.00000000001, "MM7"},
