...
TEST_F(SetsTest, SAddTest) {  // NOLINT
  ...
  s = db.SAdd("SADD_KEY", members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("SADD_KEY", members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("SADD_KEY", members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("SADD_KEY", members4, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ASSERT_TRUE(size_match(&db, "SADD_KEY", 3));
  ...
  s = db.SAdd("SADD_KEY", members5, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
...
TEST_F(SetsTest, SCardTest) {  // NOLINT
  ...
  s = db.SAdd("SCARD_KEY", members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SDiffTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SDIFF_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SDIFF_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP1_SDIFF_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP2_SDIFF_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
  s = db.SAdd("GP2_SDIFF_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP2_SDIFF_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP3_SDIFF_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  s = db.SAdd("GP4_SDIFF_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP4_SDIFF_KEY2", gp4_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP4_SDIFF_KEY3", gp4_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("", gp5_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP5_SDIFF_KEY2", gp5_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP5_SDIFF_KEY3", gp5_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SDiffstoreTest) {  // NOLINT
  ...
  std::vector<std::string> gp1_members2{"c"};
  std::vector<std::string> gp1_members3{"a", "c", "e"};
  s = db.SAdd("GP1_SDIFFSTORE_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SDIFFSTORE_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP1_SDIFFSTORE_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp2_members2{"c"};
  std::vector<std::string> gp2_members3{"a", "c", "e"};
  s = db.SAdd("GP2_SDIFFSTORE_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 0);
  s = db.SAdd("GP2_SDIFFSTORE_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP2_SDIFFSTORE_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  // destination = {a, b, c, d}
  std::vector<std::string> gp3_members1{"a", "b", "c", "d"};
  s = db.SAdd("GP3_SDIFFSTORE_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  std::vector<std::string> gp4_members2{"c"};
  std::vector<std::string> gp4_members3{"a", "c", "e"};
  s = db.SAdd("GP4_SDIFFSTORE_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP4_SDIFFSTORE_KEY2", gp4_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP4_SDIFFSTORE_KEY3", gp4_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp5_members2{"c"};
  std::vector<std::string> gp5_members3{"a", "c", "e"};
  s = db.SAdd("GP5_SDIFFSTORE_DESTINATION1", gp5_destination_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  s = db.SAdd("GP5_SDIFFSTORE_KEY1", gp5_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP5_SDIFFSTORE_KEY2", gp5_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP5_SDIFFSTORE_KEY3", gp5_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP6_SDIFFSTORE_DESTINATION1", gp6_destination_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP6_SDIFFSTORE_KEY2", gp6_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP6_SDIFFSTORE_KEY3", gp6_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP7_SDIFFSTORE_DESTINATION1", gp7_destination_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  s = db.SAdd("GP7_SDIFFSTORE_KEY1", gp7_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP7_SDIFFSTORE_KEY2", gp7_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP7_SDIFFSTORE_KEY3", gp7_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SInterTest) {  // NOLINT
  ...
  std::vector<std::string> gp1_members3{"a", "c", "e"};
  s = db.SAdd("GP1_SINTER_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SINTER_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP1_SINTER_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp2_members2{"c"};
  std::vector<std::string> gp2_members3{"a", "c", "e"};
  s = db.SAdd("GP2_SINTER_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP2_SINTER_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  s = db.SAdd("GP2_SINTER_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP3_SINTER_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP3_SINTER_KEY2", gp3_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP3_SINTER_KEY3", gp3_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP4_SINTER_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP4_SINTER_KEY2", gp4_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP4_SINTER_KEY3", gp4_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  s = db.SAdd("GP5_SINTER_KEY1", gp5_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP5_SINTER_KEY2", gp5_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP5_SINTER_KEY3", gp5_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SInterstoreTest) {  // NOLINT
  ...
  std::vector<std::string> gp1_members2{"a", "c"};
  std::vector<std::string> gp1_members3{"a", "c", "e"};
  s = db.SAdd("GP1_SINTERSTORE_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SINTERSTORE_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP1_SINTERSTORE_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp2_members3{"a", "c", "e"};
  s = db.SAdd("GP2_SINTERSTORE_DESTINATION1", gp2_destination_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  s = db.SAdd("GP2_SINTERSTORE_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP2_SINTERSTORE_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP2_SINTERSTORE_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP3_SINTERSTORE_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP3_SINTERSTORE_KEY2", gp3_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP3_SINTERSTORE_KEY3", gp3_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp4_members2{"a", "c"};
  std::vector<std::string> gp4_members3{"a", "c", "e"};
  s = db.SAdd("GP4_SINTERSTORE_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP4_SINTERSTORE_KEY2", gp4_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP4_SINTERSTORE_KEY3", gp4_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp5_members2{"a", "c"};
  std::vector<std::string> gp5_members3{"a", "c", "e"};
  s = db.SAdd("GP5_SINTERSTORE_KEY1", gp5_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP5_SINTERSTORE_KEY2", gp5_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP5_SINTERSTORE_KEY3", gp5_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp6_members3{"a", "c", "e"};
  s = db.SAdd("GP6_SINTERSTORE_KEY1", gp6_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP6_SINTERSTORE_KEY2", gp6_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP6_SINTERSTORE_KEY3", gp6_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp7_members3{"a", "c", "e"};
  s = db.SAdd("GP7_SINTERSTORE_KEY1", gp7_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP7_SINTERSTORE_KEY2", gp7_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP7_SINTERSTORE_KEY3", gp7_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP8_SINTERSTORE_KEY1", gp8_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP8_SINTERSTORE_KEY2", gp8_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP8_SINTERSTORE_KEY3", gp8_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
...
TEST_F(SetsTest, SIsmemberTest) {  // NOLINT
  ...
  s = db.SAdd("SISMEMBER_KEY", members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
...
TEST_F(SetsTest, SMembersTest) {  // NOLINT
  ...
  s = db.SAdd("B_SMEMBERS_KEY", mid_members_in, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("A_SMEMBERS_KEY", pre_members_in, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  members_out.clear();
  s = db.SMembers("B_SMEMBERS_KEY", &members_out);
  ...
  s = db.SAdd("C_SMEMBERS_KEY", suf_members_in, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  members_out.clear();
  s = db.SMembers("B_SMEMBERS_KEY", &members_out);
...
TEST_F(SetsTest, SMoveTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SMOVE_SOURCE", gp1_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SMOVE_DESTINATION", gp1_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("GP2_SMOVE_SOURCE", gp2_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP2_SMOVE_DESTINATION", gp2_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("GP3_SMOVE_SOURCE", gp3_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  s = db.SAdd("GP3_SMOVE_DESTINATION", gp3_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("GP4_SMOVE_SOURCE", gp4_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP5_SMOVE_SOURCE", gp5_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP5_SMOVE_DESTINATION", gp5_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP6_SMOVE_SOURCE", gp6_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP6_SMOVE_DESTINATION", gp6_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("GP7_SMOVE_SOURCE", gp7_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP7_SMOVE_DESTINATION", gp7_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  s = db.SAdd("GP8_SMOVE_SOURCE", gp8_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP8_SMOVE_DESTINATION", gp8_destination, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP9_SMOVE_SOURCE", gp8_source, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
...
TEST_F(SetsTest, SPopTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SPOP_KEY", gp1_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP2_SPOP_KEY", gp2_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  ...
  s = db.SAdd("GP3_SPOP_KEY", gp3_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 100);
  ...
  s = db.SAdd("GP4_SPOP_KEY", gp4_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 10000);
  ...
  s = db.SAdd("GP5_SPOP_KEY", gp5_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP6_SPOP_KEY", gp6_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP7_SPOP_KEY", gp7_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SRanmemberTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SRANDMEMBER_KEY", gp1_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
  ...
  // ***************** Group 2 Test *****************
  s = db.SAdd("GP2_SRANDMEMBER_KEY", {"MM"}, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 1);
  ...
  s = db.SAdd("GP3_SRANDMEMBER_KEY", gp3_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
...
TEST_F(SetsTest, SRemTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SREM_KEY", gp1_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  s = db.SAdd("GP2_SREM_KEY", gp2_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  ...
  s = db.SAdd("GP4_SREM_KEY", gp4_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
...
TEST_F(SetsTest, SUnionTest) {  // NOLINT
  ...
  std::vector<std::string> gp1_members2{"a", "c"};
  std::vector<std::string> gp1_members3{"a", "c", "e"};
  s = db.SAdd("GP1_SUNION_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SUNION_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP1_SUNION_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp2_members2{"a", "c"};
  std::vector<std::string> gp2_members3{"a", "c", "e"};
  s = db.SAdd("GP2_SUNION_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP2_SUNION_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP2_SUNION_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP3_SUNION_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP3_SUNION_KEY2", gp3_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP3_SUNION_KEY3", gp3_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 5);
  ...
  // SUNION key1 = {a, b, c, d}
  std::vector<std::string> gp4_members1{"a", "b", "c", "d"};
  s = db.SAdd("GP4_SUNION_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
...
TEST_F(SetsTest, SUnionstoreTest) {  // NOLINT
  ...
  std::vector<std::string> gp1_members2{"a", "c"};
  std::vector<std::string> gp1_members3{"a", "c", "e"};
  s = db.SAdd("GP1_SUNIONSTORE_KEY1", gp1_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP1_SUNIONSTORE_KEY2", gp1_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP1_SUNIONSTORE_KEY3", gp1_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  std::vector<std::string> gp2_members2{"a", "c"};
  std::vector<std::string> gp2_members3{"a", "c", "e"};
  s = db.SAdd("GP2_SUNIONSTORE_KEY1", gp2_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP2_SUNIONSTORE_KEY2", gp2_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP2_SUNIONSTORE_KEY3", gp2_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP3_SUNIONSTORE_KEY1", gp3_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 4);
  s = db.SAdd("GP3_SUNIONSTORE_KEY2", gp3_members2, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  s = db.SAdd("GP3_SUNIONSTORE_KEY3", gp3_members3, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
  ...
  s = db.SAdd("GP4_SUNIONSTORE_KEY1", gp4_members1, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 3);
...
TEST_F(SetsTest, SScanTest) {  // NOLINT
  ...
  s = db.SAdd("GP1_SSCAN_KEY", gp1_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
  ...
  s = db.SAdd("GP2_SSCAN_KEY", gp2_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
  ...
  s = db.SAdd("GP3_SSCAN_KEY", gp3_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
  ...
  s = db.SAdd("GP4_SSCAN_KEY", gp4_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 8);
  ...
  s = db.SAdd("GP5_SSCAN_KEY", gp5_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
  ...
  s = db.SAdd("GP6_SSCAN_KEY", gp6_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
  ...
  s = db.SAdd("GP7_SSCAN_KEY", gp7_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
  ...
  s = db.SAdd("GP8_SSCAN_KEY", gp8_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
  ...
  s = db.SAdd("GP9_SSCAN_KEY", gp9_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
  ...
  s = db.SAdd("GP10_SSCAN_KEY", gp10_members, &ret, <#initializer #>);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 9);
