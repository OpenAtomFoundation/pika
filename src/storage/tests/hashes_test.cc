...
TEST_F(HashesTest, HIncrby) {
  ...
  s = db.HIncrby("GP1_HINCRBY_KEY", "GP1_HINCRBY_FIELD", 1, &value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(value, 2);
  ...
  s = db.HIncrby("GP2_HINCRBY_KEY", "GP2_HINCRBY_FIELD", 1, &value, nullptr);
  ...
  s = db.HIncrby("GP3_HINCRBY_KEY", "GP3_HINCRBY_FIELD", 1, &value, nullptr);
  ASSERT_TRUE(s.IsCorruption());
  ASSERT_EQ(value, 0);

  // If key does not exist the value is set to 0 before the
  // operation is performed
  s = db.HIncrby("HINCRBY_NEW_KEY", "HINCRBY_EXIST_FIELD", 1000, &value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  ASSERT_TRUE(s.ok());
  s = db.HIncrby("HINCRBY_KEY", "HINCRBY_STR_FIELD", 100, &value, nullptr);
  ASSERT_TRUE(s.IsCorruption());

  // If field does not exist the value is set to 0 before the
  // operation is performed
  s = db.HIncrby("HINCRBY_KEY", "HINCRBY_NOT_EXIST_FIELD", 100, &value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(value, 100);
  ...
  // Positive test
  s = db.HIncrby("HINCRBY_KEY", "HINCRBY_NUM_FIELD", 100, &value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(value, 200);
  ...
  ASSERT_TRUE(s.ok());
  s = db.HIncrby("HINCRBY_KEY", "HINCRBY_NUM_FIELD", 9223372036854775807, &value, nullptr);
...
TEST_F(HashesTest, HIncrbyfloat) {
  ...
  s = db.HIncrbyfloat("GP1_HINCRBYFLOAT_KEY", "GP1_HINCRBYFLOAT_FIELD", "1.234", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  s = db.HIncrbyfloat("GP2_HINCRBYFLOAT_KEY", "GP2_HINCRBYFLOAT_FIELD", "1.234", &new_value, nullptr);
  ASSERT_TRUE(s.IsCorruption());
  ASSERT_EQ(new_value, "");
  ...
  s = db.HIncrbyfloat("GP3_HINCRBYFLOAT_KEY", "GP3_HINCRBYFLOAT_FIELD", "1.234", &new_value, nullptr);
  ASSERT_TRUE(s.IsCorruption());
  ASSERT_EQ(new_value, "");

  // If the specified increment are not parsable as a double precision
  // floating point number
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_FIELD", "HINCRBYFLOAT_BY", &new_value, nullptr);
  ASSERT_TRUE(s.IsCorruption());
  ...
  // If key does not exist the value is set to 0 before the
  // operation is performed
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_FIELD", "12.3456", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  ASSERT_TRUE(s.ok());
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_STR_FIELD", "123.456", &new_value, nullptr);
  ASSERT_TRUE(s.IsCorruption());
  s = db.HLen("HINCRBYFLOAT_KEY", &ret);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(ret, 2);
  ...
  // If field does not exist the value is set to 0 before the
  // operation is performed
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_NOT_EXIST_FIELD", "65.4321000", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // Positive test
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_NUM_FIELD", "+123.456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // ***** Special test *****
  // case 1
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD1", "2.0e2", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // case2
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD2", "5.0e3", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "5000");
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD2", "2.0e2", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // case 3
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD3", "5.0e3", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "5000");
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD3", "-2.0e2", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // case 4
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD4", ".456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // case5
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD5", "-.456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "-0.456789");
  ...
  // case6
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD6", "+.456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "0.456789");
  ...
  // case7
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD7", "+.456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "0.456789");
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD7", "-.456789", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ...
  // case8
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD8", "-00000.456789000", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "-0.456789");
  ...
  // case9
  s = db.HIncrbyfloat("HINCRBYFLOAT_KEY", "HINCRBYFLOAT_SP_FIELD9", "+00000.456789000", &new_value, nullptr);
  ASSERT_TRUE(s.ok());
  ASSERT_EQ(new_value, "0.456789");
