...
void InitCmdTable(CmdTable* cmd_table) {
  ...
  std::unique_ptr<Cmd> slaveofptr =
      std::make_unique<SlaveofCmd>(kCmdNameSlaveof, -3, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> compactptr =
      std::make_unique<CompactCmd>(kCmdNameCompact, -1, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> pingptr =
      std::make_unique<PingCmd>(kCmdNamePing, 1, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> selectptr =
      std::make_unique<SelectCmd>(kCmdNameSelect, 2, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> flushallptr = std::make_unique<FlushallCmd>(
      kCmdNameFlushall, 1, kCmdFlagsWrite | kCmdFlagsSuspend | kCmdFlagsAdmin  | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB);
  ...
  std::unique_ptr<Cmd> flushdbptr = std::make_unique<FlushdbCmd>(
      kCmdNameFlushdb, -1, kCmdFlagsWrite | kCmdFlagsSuspend | kCmdFlagsAdmin  | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameFlushdb, std::move(flushdbptr)));

  std::unique_ptr<Cmd> clientptr =
      std::make_unique<ClientCmd>(kCmdNameClient, -2, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> quitptr =
      std::make_unique<QuitCmd>(kCmdNameQuit, 1, kCmdFlagsRead | kCmdFlagsNoAuth );
  ...
  std::unique_ptr<Cmd> clearreplicationidptr = std::make_unique<ClearReplicationIDCmd>(
      kCmdNameClearReplicationID, 1, kCmdFlagsWrite | kCmdFlagsAdmin );
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> commandptr =
      std::make_unique<CommandCmd>(kCmdNameCommand, -1, kCmdFlagsRead | kCmdFlagsAdmin );
  ...
  std::unique_ptr<Cmd> slotmgrtasyncstatus = std::make_unique<SlotsMgrtAsyncStatusCmd>(
      kCmdNameSlotsMgrtAsyncStatus, 1, kCmdFlagsRead | kCmdFlagsAdmin );
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> slotmgrtasynccancel = std::make_unique<SlotsMgrtAsyncCancelCmd>(
      kCmdNameSlotsMgrtAsyncCancel, 1, kCmdFlagsRead | kCmdFlagsAdmin );
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> slotmgrttagslotptr = std::make_unique<SlotsMgrtTagSlotCmd>(
      kCmdNameSlotsMgrtTagSlot, 5, kCmdFlagsRead | kCmdFlagsAdmin );
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> delptr =
      std::make_unique<DelCmd>(kCmdNameDel, -2, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsOperateKey  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameDel, std::move(delptr)));
  std::unique_ptr<Cmd> Unlinkptr =
      std::make_unique<DelCmd>(kCmdNameUnlink, -2, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsOperateKey );
  ...
  std::unique_ptr<Cmd> incrbyptr = std::make_unique<IncrbyCmd>(
      kCmdNameIncrby, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> incrbyfloatptr = std::make_unique<IncrbyfloatCmd>(
      kCmdNameIncrbyfloat, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> decrbyptr = std::make_unique<DecrbyCmd>(
      kCmdNameDecrby, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> getsetptr = std::make_unique<GetsetCmd>(
      kCmdNameGetset, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> appendptr = std::make_unique<AppendCmd>(
      kCmdNameAppend, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameAppend, std::move(appendptr)));
  ////MgetCmd
  std::unique_ptr<Cmd> mgetptr =
      std::make_unique<MgetCmd>(kCmdNameMget, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsReadCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameMget, std::move(mgetptr)));
  ////KeysCmd
  std::unique_ptr<Cmd> keysptr =
      std::make_unique<KeysCmd>(kCmdNameKeys, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsOperateKey );
  ...
  std::unique_ptr<Cmd> msetptr =
      std::make_unique<MsetCmd>(kCmdNameMset, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsKv   | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> getrangeptr = std::make_unique<GetrangeCmd>(
      kCmdNameGetrange, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsReadCache);
  ...
  std::unique_ptr<Cmd> setrangeptr = std::make_unique<SetrangeCmd>(
      kCmdNameSetrange, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv  | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> existsptr =
      std::make_unique<ExistsCmd>(kCmdNameExists, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache);
  ...
  std::unique_ptr<Cmd> expireptr = std::make_unique<ExpireCmd>(
      kCmdNameExpire, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> pexpireptr = std::make_unique<PexpireCmd>(
      kCmdNamePexpire, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> expireatptr =
      std::make_unique<ExpireatCmd>(kCmdNameExpireat, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> pexpireatptr =
      std::make_unique<PexpireatCmd>(kCmdNamePexpireat, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePexpireat, std::move(pexpireatptr)));
  ////TtlCmd
  std::unique_ptr<Cmd> ttlptr =
      std::make_unique<TtlCmd>(kCmdNameTtl, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameTtl, std::move(ttlptr)));
  ////PttlCmd
  std::unique_ptr<Cmd> pttlptr =
      std::make_unique<PttlCmd>(kCmdNamePttl, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePttl, std::move(pttlptr)));
  ////PersistCmd
  std::unique_ptr<Cmd> persistptr =
      std::make_unique<PersistCmd>(kCmdNamePersist, 2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePersist, std::move(persistptr)));
  ////TypeCmd
  std::unique_ptr<Cmd> typeptr =
      std::make_unique<TypeCmd>(kCmdNameType, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey  | kCmdFlagsDoThroughDB | kCmdFlagsReadCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameType, std::move(typeptr)));
  ////PTypeCmd
  std::unique_ptr<Cmd> pTypeptr =
      std::make_unique<PTypeCmd>(kCmdNamePType, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePType, std::move(pTypeptr)));
  ////ScanCmd
  std::unique_ptr<Cmd> scanptr =
      std::make_unique<ScanCmd>(kCmdNameScan, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsOperateKey );
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameScan, std::move(scanptr)));
  ////ScanxCmd
  std::unique_ptr<Cmd> scanxptr =
      std::make_unique<ScanxCmd>(kCmdNameScanx, -3, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsOperateKey );
  ...
  std::unique_ptr<Cmd> pkscanrangeptr = std::make_unique<PKScanRangeCmd>(
      kCmdNamePKScanRange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey );
  ...
  std::unique_ptr<Cmd> pkrscanrangeptr = std::make_unique<PKRScanRangeCmd>(
      kCmdNamePKRScanRange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsOperateKey );
  ...
  std::unique_ptr<Cmd> pkhscanrangeptr = std::make_unique<PKHScanRangeCmd>(
      kCmdNamePKHScanRange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsHash );
  ...
  std::unique_ptr<Cmd> lpushptr = std::make_unique<LPushCmd>(
      kCmdNameLPush, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> lrangeptr = std::make_unique<LRangeCmd>(
      kCmdNameLRange, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> brpopptr = std::make_unique<BRPopCmd>(
      kCmdNameBRpop, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList );
  ...
  std::unique_ptr<Cmd> zunionstoreptr =
      std::make_unique<ZUnionstoreCmd>(kCmdNameZUnionstore, -4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsZset |kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zinterstoreptr =
      std::make_unique<ZInterstoreCmd>(kCmdNameZInterstore, -4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsZset |kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zpopmaxptr = std::make_unique<ZPopmaxCmd>(
      kCmdNameZPopmax, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset );
  ...
  std::unique_ptr<Cmd> zpopminptr = std::make_unique<ZPopminCmd>(
      kCmdNameZPopmin, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset );
  ...
  std::unique_ptr<Cmd> sunionstoreptr =
      std::make_unique<SUnionstoreCmd>(kCmdNameSUnionstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sinterstoreptr =
      std::make_unique<SInterstoreCmd>(kCmdNameSInterstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sdiffstoreptr =
      std::make_unique<SDiffstoreCmd>(kCmdNameSDiffstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet |kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> smoveptr =
      std::make_unique<SMoveCmd>(kCmdNameSMove, 4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> bitgetptr =
      std::make_unique<BitGetCmd>(kCmdNameBitGet, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameBitGet, std::move(bitgetptr)));
  ////bitcountCmd
  std::unique_ptr<Cmd> bitcountptr =
      std::make_unique<BitCountCmd>(kCmdNameBitCount, -2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> bitposptr =
      std::make_unique<BitPosCmd>(kCmdNameBitPos, -3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameBitPos, std::move(bitposptr)));
  ////bitopCmd
  std::unique_ptr<Cmd> bitopptr =
      std::make_unique<BitOpCmd>(kCmdNameBitOp, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsBit | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> pfcountptr = std::make_unique<PfCountCmd>(
      kCmdNamePfCount, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsHyperLogLog );
  ...
  std::unique_ptr<Cmd> pfmergeptr = std::make_unique<PfMergeCmd>(
      kCmdNamePfMerge, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsHyperLogLog );
  ...
  std::unique_ptr<Cmd> publishptr =
      std::make_unique<PublishCmd>(kCmdNamePublish, 3, kCmdFlagsRead | kCmdFlagsPubSub );
  ...
  std::unique_ptr<Cmd> pubsubptr =
      std::make_unique<PubSubCmd>(kCmdNamePubSub, -2, kCmdFlagsRead | kCmdFlagsPubSub );
  ...
  std::unique_ptr<Cmd> execptr = std::make_unique<ExecCmd>(
      kCmdNameExec, 1, kCmdFlagsRead | kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSuspend );
  ...
  std::unique_ptr<Cmd> xrerverangeptr =
        std::make_unique<XRevrangeCmd>(kCmdNameXRevrange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsStream);
  ...
  std::unique_ptr<Cmd> xtrimptr =
      std::make_unique<XTrimCmd>(kCmdNameXTrim, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsStream);
