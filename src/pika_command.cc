...
void InitCmdTable(CmdTable* cmd_table) {
  ...
  std::unique_ptr<Cmd> incrptr =
      std::make_unique<IncrCmd>(kCmdNameIncr, 2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameIncr, std::move(incrptr)));
  ////IncrbyCmd
  std::unique_ptr<Cmd> incrbyptr =
      std::make_unique<IncrbyCmd>(kCmdNameIncrby, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> incrbyfloatptr =
      std::make_unique<IncrbyfloatCmd>(kCmdNameIncrbyfloat, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> decrptr =
      std::make_unique<DecrCmd>(kCmdNameDecr, 2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameDecr, std::move(decrptr)));
  ////DecrbyCmd
  std::unique_ptr<Cmd> decrbyptr =
      std::make_unique<DecrbyCmd>(kCmdNameDecrby, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameDecrby, std::move(decrbyptr)));
  ////GetsetCmd
  std::unique_ptr<Cmd> getsetptr =
      std::make_unique<GetsetCmd>(kCmdNameGetset, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameGetset, std::move(getsetptr)));
  ////AppendCmd
  std::unique_ptr<Cmd> appendptr =
      std::make_unique<AppendCmd>(kCmdNameAppend, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> setexptr =
      std::make_unique<SetexCmd>(kCmdNameSetex, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> msetnxptr =
      std::make_unique<MsetnxCmd>(kCmdNameMsetnx, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsKv | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameMsetnx, std::move(msetnxptr)));
  ////GetrangeCmd
  std::unique_ptr<Cmd> getrangeptr =
      std::make_unique<GetrangeCmd>(kCmdNameGetrange, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache | kCmdFlagsPreDo);
  ...
  std::unique_ptr<Cmd> setrangeptr =
      std::make_unique<SetrangeCmd>(kCmdNameSetrange, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> strlenptr =
      std::make_unique<StrlenCmd>(kCmdNameStrlen, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameStrlen, std::move(strlenptr)));
  ////ExistsCmd
  std::unique_ptr<Cmd> existsptr =
      std::make_unique<ExistsCmd>(kCmdNameExists, -2, kCmdFlagsRead | kCmdFlagsMultiSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsPreDo);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameExists, std::move(existsptr)));
  ////ExpireCmd
  std::unique_ptr<Cmd> expireptr =
      std::make_unique<ExpireCmd>(kCmdNameExpire, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameExpire, std::move(expireptr)));
  ////PexpireCmd
  std::unique_ptr<Cmd> pexpireptr =
      std::make_unique<PexpireCmd>(kCmdNamePexpire, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> pexpireatptr =
      std::make_unique<PexpireatCmd>(kCmdNamePexpireat, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePexpireat, std::move(pexpireatptr)));
  ////TtlCmd
  std::unique_ptr<Cmd> ttlptr =
      std::make_unique<TtlCmd>(kCmdNameTtl, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameTtl, std::move(ttlptr)));
  ////PttlCmd
  std::unique_ptr<Cmd> pttlptr =
      std::make_unique<PttlCmd>(kCmdNamePttl, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsPreDo);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePttl, std::move(pttlptr)));
  ////PersistCmd
  std::unique_ptr<Cmd> persistptr =
      std::make_unique<PersistCmd>(kCmdNamePersist, 2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePersist, std::move(persistptr)));
  ////TypeCmd
  std::unique_ptr<Cmd> typeptr =
      std::make_unique<TypeCmd>(kCmdNameType, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsKv |  kCmdFlagsDoFromCache | kCmdFlagsPreDo);
  ...
  std::unique_ptr<Cmd> lindexptr =
      std::make_unique<LIndexCmd>(kCmdNameLIndex, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLIndex, std::move(lindexptr)));
  std::unique_ptr<Cmd> linsertptr =
      std::make_unique<LInsertCmd>(kCmdNameLInsert, 5, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLInsert, std::move(linsertptr)));
  std::unique_ptr<Cmd> llenptr =
      std::make_unique<LLenCmd>(kCmdNameLLen, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> lpopptr =
      std::make_unique<LPopCmd>(kCmdNameLPop, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLPop, std::move(lpopptr)));
  std::unique_ptr<Cmd> lpushptr =
      std::make_unique<LPushCmd>(kCmdNameLPush, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLPush, std::move(lpushptr)));
  std::unique_ptr<Cmd> lpushxptr =

      std::make_unique<LPushxCmd>(kCmdNameLPushx, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> lrangeptr =
      std::make_unique<LRangeCmd>(kCmdNameLRange, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLRange, std::move(lrangeptr)));
  std::unique_ptr<Cmd> lremptr =
      std::make_unique<LRemCmd>(kCmdNameLRem, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLRem, std::move(lremptr)));
  std::unique_ptr<Cmd> lsetptr =
      std::make_unique<LSetCmd>(kCmdNameLSet, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLSet, std::move(lsetptr)));
  std::unique_ptr<Cmd> ltrimptr =
      std::make_unique<LTrimCmd>(kCmdNameLTrim, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> rpopptr =
      std::make_unique<RPopCmd>(kCmdNameRPop, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameRPop, std::move(rpopptr)));
  std::unique_ptr<Cmd> rpoplpushptr =
      std::make_unique<RPopLPushCmd>(kCmdNameRPopLPush, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsPreDo);
  ...
  std::unique_ptr<Cmd> rpushptr =
      std::make_unique<RPushCmd>(kCmdNameRPush, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::make_unique<RPushxCmd>(kCmdNameRPushx, 3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsList | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameRPushx, std::move(rpushxptr)));

  // Zset
  ////ZAddCmd
  std::unique_ptr<Cmd> zaddptr =
      std::make_unique<ZAddCmd>(kCmdNameZAdd, -4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZAdd, std::move(zaddptr)));
  ////ZCardCmd
  std::unique_ptr<Cmd> zcardptr =
      std::make_unique<ZCardCmd>(kCmdNameZCard, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zincrbyptr =
      std::make_unique<ZIncrbyCmd>(kCmdNameZIncrby, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache) ;
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZIncrby, std::move(zincrbyptr)));
  ////ZRangeCmd
  std::unique_ptr<Cmd> zrangeptr =
      std::make_unique<ZRangeCmd>(kCmdNameZRange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZRange, std::move(zrangeptr)));
  ////ZRevrangeCmd
  std::unique_ptr<Cmd> zrevrangeptr =
      std::make_unique<ZRevrangeCmd>(kCmdNameZRevrange, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zrangebyscoreptr = std::make_unique<ZRangebyscoreCmd>(
      kCmdNameZRangebyscore, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset| kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zrevrangebyscoreptr = std::make_unique<ZRevrangebyscoreCmd>(
      kCmdNameZRevrangebyscore, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset| kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(
      std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZRevrangebyscore, std::move(zrevrangebyscoreptr)));
  ////ZCountCmd
  std::unique_ptr<Cmd> zcountptr =
      std::make_unique<ZCountCmd>(kCmdNameZCount, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZCount, std::move(zcountptr)));
  ////ZRemCmd
  std::unique_ptr<Cmd> zremptr =
      std::make_unique<ZRemCmd>(kCmdNameZRem, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZRem, std::move(zremptr)));
  ////ZUnionstoreCmd
  std::unique_ptr<Cmd> zunionstoreptr =
      std::make_unique<ZUnionstoreCmd>(kCmdNameZUnionstore, -4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zinterstoreptr =
      std::make_unique<ZInterstoreCmd>(kCmdNameZInterstore, -4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zrankptr =
      std::make_unique<ZRankCmd>(kCmdNameZRank, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZRank, std::move(zrankptr)));
  ////ZRevrankCmd
  std::unique_ptr<Cmd> zrevrankptr =
      std::make_unique<ZRevrankCmd>(kCmdNameZRevrank, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zscoreptr =
      std::make_unique<ZScoreCmd>(kCmdNameZScore, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zrangebylexptr =
      std::make_unique<ZRangebylexCmd>(kCmdNameZRangebylex, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zrevrangebylexptr = std::make_unique<ZRevrangebylexCmd>(
      kCmdNameZRevrangebylex, -4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zlexcountptr =
      std::make_unique<ZLexcountCmd>(kCmdNameZLexcount, 4, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsZset| kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zremrangebyrankptr = std::make_unique<ZRemrangebyrankCmd>(
      kCmdNameZRemrangebyrank, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> zremrangebyscoreptr = std::make_unique<ZRemrangebyscoreCmd>(
      kCmdNameZRemrangebyscore, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(
  ...
  std::unique_ptr<Cmd> zremrangebylexptr = std::make_unique<ZRemrangebylexCmd>(
      kCmdNameZRemrangebylex, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> zpopmaxptr =
      std::make_unique<ZPopmaxCmd>(kCmdNameZPopmax, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsZset | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> saddptr =
      std::make_unique<SAddCmd>(kCmdNameSAdd, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameSAdd, std::move(saddptr)));
  ////SPopCmd
  std::unique_ptr<Cmd> spopptr =
      std::make_unique<SPopCmd>(kCmdNameSPop, -2, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameSPop, std::move(spopptr)));
  ////SCardCmd
  std::unique_ptr<Cmd> scardptr =
      std::make_unique<SCardCmd>(kCmdNameSCard, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameSCard, std::move(scardptr)));
  ////SMembersCmd
  std::unique_ptr<Cmd> smembersptr =
      std::make_unique<SMembersCmd>(kCmdNameSMembers, 2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sremptr =
      std::make_unique<SRemCmd>(kCmdNameSRem, -3, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sunionstoreptr =
      std::make_unique<SUnionstoreCmd>(kCmdNameSUnionstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sinterstoreptr =
      std::make_unique<SInterstoreCmd>(kCmdNameSInterstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sismemberptr =
      std::make_unique<SIsmemberCmd>(kCmdNameSIsmember, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> sdiffstoreptr =
      std::make_unique<SDiffstoreCmd>(kCmdNameSDiffstore, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> smoveptr =
      std::make_unique<SMoveCmd>(kCmdNameSMove, 4, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsSet | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameSMove, std::move(smoveptr)));
  ////SRandmemberCmd
  std::unique_ptr<Cmd> srandmemberptr =
      std::make_unique<SRandmemberCmd>(kCmdNameSRandmember, -2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsSet| kCmdFlagsDoFromCache | kCmdFlagsPreDo | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> bitsetptr =
      std::make_unique<BitSetCmd>(kCmdNameBitSet, 4, kCmdFlagsWrite | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameBitSet, std::move(bitsetptr)));
  ////bitgetCmd
  std::unique_ptr<Cmd> bitgetptr =
      std::make_unique<BitGetCmd>(kCmdNameBitGet, 3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache | kCmdFlagsPreDo);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameBitGet, std::move(bitgetptr)));
  ////bitcountCmd
  std::unique_ptr<Cmd> bitcountptr =
      std::make_unique<BitCountCmd>(kCmdNameBitCount, -2, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache | kCmdFlagsPreDo);
  ...
  std::unique_ptr<Cmd> bitposptr =
      std::make_unique<BitPosCmd>(kCmdNameBitPos, -3, kCmdFlagsRead | kCmdFlagsSingleSlot | kCmdFlagsBit | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameBitPos, std::move(bitposptr)));
  ////bitopCmd
  std::unique_ptr<Cmd> bitopptr =
      std::make_unique<BitOpCmd>(kCmdNameBitOp, -3, kCmdFlagsWrite | kCmdFlagsMultiSlot | kCmdFlagsBit | kCmdFlagsDoFromCache | kCmdFlagsUpdateCache | kCmdFlagsPreDo);
