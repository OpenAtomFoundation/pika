...
void InitCmdTable(CmdTable* cmd_table) {
  ...
  std::unique_ptr<Cmd> compactptr = std::make_unique<CompactCmd>(
      kCmdNameCompact, -1, kCmdFlagsRead | kCmdFlagsAdmin | kCmdFlagsSlow | kCmdFlagsSuspend);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameCompact, std::move(compactptr)));

  std::unique_ptr<Cmd> compactrangeptr =
      std::make_unique<CompactRangeCmd>(kCmdNameCompactRange, 4, kCmdFlagsRead | kCmdFlagsAdmin | kCmdFlagsSuspend);
  ...
  std::unique_ptr<Cmd> flushallptr = std::make_unique<FlushallCmd>(
      kCmdNameFlushall, 1,
      kCmdFlagsWrite | kCmdFlagsSuspend | kCmdFlagsAdmin | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> clearcacheptr =
      std::make_unique<ClearCacheCmd>(kCmdNameClearCache, 1, kCmdFlagsAdmin | kCmdFlagsWrite);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameClearCache, std::move(clearcacheptr)));
  std::unique_ptr<Cmd> lastsaveptr =
      std::make_unique<LastsaveCmd>(kCmdNameLastSave, 1, kCmdFlagsAdmin | kCmdFlagsRead | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> setptr = std::make_unique<SetCmd>(
      kCmdNameSet, -3, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> getptr = std::make_unique<GetCmd>(
      kCmdNameGet, 2,
      kCmdFlagsRead | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsReadCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> delptr = std::make_unique<DelCmd>(
      kCmdNameDel, -2,
      kCmdFlagsWrite | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> incrptr = std::make_unique<IncrCmd>(
      kCmdNameIncr, 2, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> incrbyfloatptr = std::make_unique<IncrbyfloatCmd>(
      ...
      kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> decrptr = std::make_unique<DecrCmd>(
      kCmdNameDecr, 2, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> mgetptr = std::make_unique<MgetCmd>(
      kCmdNameMget, -2,
      kCmdFlagsRead | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> setexptr = std::make_unique<SetexCmd>(
      kCmdNameSetex, 4, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> psetexptr = std::make_unique<PsetexCmd>(
      kCmdNamePsetex, 4, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> msetptr = std::make_unique<MsetCmd>(
      kCmdNameMset, -3, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameMset, std::move(msetptr)));
  ////MSetnxCmd
  std::unique_ptr<Cmd> msetnxptr =
      std::make_unique<MsetnxCmd>(kCmdNameMsetnx, -3, kCmdFlagsWrite | kCmdFlagsKv | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> existsptr = std::make_unique<ExistsCmd>(
      kCmdNameExists, -2,
      kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> ttlptr = std::make_unique<TtlCmd>(
      kCmdNameTtl, 2, kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> pttlptr = std::make_unique<PttlCmd>(
      kCmdNamePttl, 2, kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> typeptr = std::make_unique<TypeCmd>(
      kCmdNameType, 2, kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> pkscanrangeptr =
      std::make_unique<PKScanRangeCmd>(kCmdNamePKScanRange, -4, kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> pkrscanrangeptr =
      std::make_unique<PKRScanRangeCmd>(kCmdNamePKRScanRange, -4, kCmdFlagsRead | kCmdFlagsOperateKey | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> hdelptr = std::make_unique<HDelCmd>(
      kCmdNameHDel, -3, kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hsetptr = std::make_unique<HSetCmd>(
      kCmdNameHSet, 4, kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hgetptr = std::make_unique<HGetCmd>(
      kCmdNameHGet, 3,
      kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hgetallptr = std::make_unique<HGetallCmd>(
      kCmdNameHGetall, 2,
      kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsSlow | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsReadCache);
  ...
  std::unique_ptr<Cmd> hincrbyptr = std::make_unique<HIncrbyCmd>(
      kCmdNameHIncrby, 4, kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hincrbyfloatptr = std::make_unique<HIncrbyfloatCmd>(
      ...
      kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hmsetptr = std::make_unique<HMsetCmd>(
      kCmdNameHMset, -4, kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hsetnxptr = std::make_unique<HSetnxCmd>(
      kCmdNameHSetnx, 4, kCmdFlagsWrite | kCmdFlagsHash | kCmdFlagsUpdateCache | kCmdFlagsDoThroughDB | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> hscanptr =
      std::make_unique<HScanCmd>(kCmdNameHScan, -3, kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsSlow);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameHScan, std::move(hscanptr)));
  ////HScanxCmd
  std::unique_ptr<Cmd> hscanxptr =
      std::make_unique<HScanxCmd>(kCmdNameHScanx, -3, kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> pkhscanrangeptr =
      std::make_unique<PKHScanRangeCmd>(kCmdNamePKHScanRange, -4, kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsSlow);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHScanRange, std::move(pkhscanrangeptr)));
  ////PKHRScanRange
  std::unique_ptr<Cmd> pkhrscanrangeptr =
      std::make_unique<PKHRScanRangeCmd>(kCmdNamePKHRScanRange, -4, kCmdFlagsRead | kCmdFlagsHash | kCmdFlagsSlow);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHRScanRange, std::move(pkhrscanrangeptr)));

  // Pika Expire Hash
  std::unique_ptr<Cmd> ehsetptr = std::make_unique<PKHSetCmd>(kCmdNamePKHSet, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHSet, std::move(ehsetptr)));

  ////Ehexpire
  std::unique_ptr<Cmd> ehexpireptr =
      std::make_unique<PKHExpireCmd>(kCmdNamePKHExpire, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  ...
  ////Ehttl
  std::unique_ptr<Cmd> ehttlptr = std::make_unique<PKHTTLCmd>(kCmdNamePKHTTL, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHTTL, std::move(ehttlptr)));

  ////Ehpersist
  std::unique_ptr<Cmd> ehpersistptr =
      std::make_unique<PKHPersistCmd>(kCmdNamePKHPersist, -4, kCmdFlagsWrite | kCmdFlagsPKHash);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNamePKHPersist, std::move(ehpersistptr)));
  ////Ehget
  std::unique_ptr<Cmd> ehgetptr = std::make_unique<PKHGetCmd>(kCmdNamePKHGet, 3, kCmdFlagsRead | kCmdFlagsPKHash);
  ...
  std::unique_ptr<Cmd> lindexptr = std::make_unique<LIndexCmd>(
      kCmdNameLIndex, 3,
      kCmdFlagsRead | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> linsertptr = std::make_unique<LInsertCmd>(
      kCmdNameLInsert, 5, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> llenptr = std::make_unique<LLenCmd>(
      kCmdNameLLen, 2,
      kCmdFlagsRead | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLLen, std::move(llenptr)));
  std::unique_ptr<Cmd> blpopptr =
      std::make_unique<BLPopCmd>(kCmdNameBLPop, -3, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> lpopptr = std::make_unique<LPopCmd>(
      kCmdNameLPop, -2, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> lpushxptr = std::make_unique<LPushxCmd>(
      kCmdNameLPushx, -3, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> lremptr = std::make_unique<LRemCmd>(
      kCmdNameLRem, 4, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> lsetptr = std::make_unique<LSetCmd>(
      kCmdNameLSet, 4, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> ltrimptr = std::make_unique<LTrimCmd>(
      kCmdNameLTrim, 4, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameLTrim, std::move(ltrimptr)));

  std::unique_ptr<Cmd> brpopptr =
      std::make_unique<BRPopCmd>(kCmdNameBRpop, -3, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> rpopptr = std::make_unique<RPopCmd>(
      kCmdNameRPop, -2, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameRPop, std::move(rpopptr)));
  std::unique_ptr<Cmd> rpoplpushptr =
      std::make_unique<RPopLPushCmd>(kCmdNameRPopLPush, 3, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> rpushptr = std::make_unique<RPushCmd>(
      kCmdNameRPush, -3, kCmdFlagsWrite | kCmdFlagsList | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> zaddptr = std::make_unique<ZAddCmd>(
      kCmdNameZAdd, -4, kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> zcardptr = std::make_unique<ZCardCmd>(
      kCmdNameZCard, 2, kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZCard, std::move(zcardptr)));
  ////ZScanCmd
  std::unique_ptr<Cmd> zscanptr =
      std::make_unique<ZScanCmd>(kCmdNameZScan, -3, kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> zincrbyptr = std::make_unique<ZIncrbyCmd>(
      kCmdNameZIncrby, 4, kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> zrangeptr = std::make_unique<ZRangeCmd>(
      kCmdNameZRange, -4,
      kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  ////ZRangebyscoreCmd
  std::unique_ptr<Cmd> zrangebyscoreptr =
      std::make_unique<ZRangebyscoreCmd>(kCmdNameZRangebyscore, -4, kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> zcountptr = std::make_unique<ZCountCmd>(
      kCmdNameZCount, 4,
      kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> zremptr = std::make_unique<ZRemCmd>(
      kCmdNameZRem, -3, kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> zunionstoreptr = std::make_unique<ZUnionstoreCmd>(
      ...
      kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> zscoreptr = std::make_unique<ZScoreCmd>(
      kCmdNameZScore, 3, kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsFast);
  ...
  ////ZRevrangebylexCmd
  std::unique_ptr<Cmd> zrevrangebylexptr =
      std::make_unique<ZRevrangebylexCmd>(kCmdNameZRevrangebylex, -4, kCmdFlagsRead | kCmdFlagsZset | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> zpopmaxptr =
      std::make_unique<ZPopmaxCmd>(kCmdNameZPopmax, -2, kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameZPopmax, std::move(zpopmaxptr)));
  ////ZPopmin
  std::unique_ptr<Cmd> zpopminptr =
      std::make_unique<ZPopminCmd>(kCmdNameZPopmin, -2, kCmdFlagsWrite | kCmdFlagsZset | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> saddptr = std::make_unique<SAddCmd>(
      kCmdNameSAdd, -3, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> spopptr = std::make_unique<SPopCmd>(
      kCmdNameSPop, -2, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> scardptr = std::make_unique<SCardCmd>(
      kCmdNameSCard, 2,
      kCmdFlagsRead | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> smembersptr = std::make_unique<SMembersCmd>(
      kCmdNameSMembers, 2,
      kCmdFlagsRead | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> sremptr = std::make_unique<SRemCmd>(
      kCmdNameSRem, -3, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameSRem, std::move(sremptr)));
  ////SUnionCmd
  std::unique_ptr<Cmd> sunionptr =
      std::make_unique<SUnionCmd>(kCmdNameSUnion, -2, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> sunionstoreptr = std::make_unique<SUnionstoreCmd>(
      ...
      kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> sinterptr =
      std::make_unique<SInterCmd>(kCmdNameSInter, -2, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsSlow);
  ...
  std::unique_ptr<Cmd> smoveptr = std::make_unique<SMoveCmd>(
      kCmdNameSMove, 4, kCmdFlagsWrite | kCmdFlagsSet | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache | kCmdFlagsFast);
  ...
  std::unique_ptr<Cmd> bitsetptr = std::make_unique<BitSetCmd>(
      kCmdNameBitSet, 4, kCmdFlagsWrite | kCmdFlagsBit | kCmdFlagsSlow | kCmdFlagsDoThroughDB | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> bitcountptr = std::make_unique<BitCountCmd>(
      kCmdNameBitCount, -2,
      kCmdFlagsRead | kCmdFlagsBit | kCmdFlagsSlow | kCmdFlagsDoThroughDB | kCmdFlagsReadCache | kCmdFlagsUpdateCache);
  ...
  std::unique_ptr<Cmd> georadiusptr =
      std::make_unique<GeoRadiusCmd>(kCmdNameGeoRadius, -6, kCmdFlagsRead | kCmdFlagsGeo | kCmdFlagsSlow);
  ...
  // Transaction
  ////Multi
  std::unique_ptr<Cmd> multiptr = std::make_unique<MultiCmd>(kCmdNameMulti, 1, kCmdFlagsRead | kCmdFlagsFast);
  cmd_table->insert(std::pair<std::string, std::unique_ptr<Cmd>>(kCmdNameMulti, std::move(multiptr)));
  ////Exec
  std::unique_ptr<Cmd> execptr =
      std::make_unique<ExecCmd>(kCmdNameExec, 1, kCmdFlagsRead | kCmdFlagsWrite | kCmdFlagsSuspend | kCmdFlagsSlow);
...
void Cmd::Execute() { ProcessCommand(); }
