...
// required int32 opcode = 1;
inline bool HbSend::has_opcode() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void HbSend::set_has_opcode() {
  _has_bits_[0] |= 0x00000001u;
}
inline void HbSend::clear_has_opcode() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void HbSend::clear_opcode() {
  opcode_ = 0;
  clear_has_opcode();
}
inline ::google::protobuf::int32 HbSend::opcode() const {
  return opcode_;
}
inline void HbSend::set_opcode(::google::protobuf::int32 value) {
  set_has_opcode();
  opcode_ = value;
}
...
// required int32 opcode = 1;
inline bool HbSendRet::has_opcode() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void HbSendRet::set_has_opcode() {
  _has_bits_[0] |= 0x00000001u;
}
inline void HbSendRet::clear_has_opcode() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void HbSendRet::clear_opcode() {
  opcode_ = 0;
  clear_has_opcode();
}
inline ::google::protobuf::int32 HbSendRet::opcode() const {
  return opcode_;
}
inline void HbSendRet::set_opcode(::google::protobuf::int32 value) {
  set_has_opcode();
  opcode_ = value;
}
