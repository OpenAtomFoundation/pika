...
PikaReplServerConn::PikaReplServerConn(net::NetID id, int fd, std::string ip_port, net::Thread* thread,
                                       void* worker_specific_data, net::NetMultiplexer* mpx)
    : PbConn(id, fd, ip_port, thread, mpx) {}
