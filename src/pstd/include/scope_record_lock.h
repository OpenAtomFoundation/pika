...
class ScopeRecordLock final : public pstd::noncopyable {
 public:
  ScopeRecordLock(std::shared_ptr<LockMgr> lock_mgr, const Slice& key)
...
class MultiScopeRecordLock final : public pstd::noncopyable {
 public:
  MultiScopeRecordLock(std::shared_ptr<LockMgr> lock_mgr,
...
class MultiRecordLock : public noncopyable {
 public:
  explicit MultiRecordLock(std::shared_ptr<LockMgr> lock_mgr)
      : lock_mgr_(lock_mgr) {}
